...
async function fetchHero() {
    ...
    if(name.length != 0){
            ...
            superHeroList.innerHTML =
                `<div id="superhero-box">
                    <div id="superhero-image">
                        <a href="./details.html?${sh.id}" target="_blank">
                    ...
                    <div>
                        ...
                        likeButton +
                        `<span> <a href="./details.html?${sh.id}" target="_blank"><i class="fa-solid fa-circle-info"></i></a> </span>
                        </div>
        ...
        superHeroList.innerHTML = `<div id="loading"><img src="./loading.gif" alt="loading....."><br>Loading......</div>`;
        let tempList = "";
